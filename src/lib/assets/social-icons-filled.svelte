...
<svg width="1em" height="1em" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" fill='currentColor' class='{name.toLowerCase()}-icon'>
...
<svg width="1em" height="1em" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" fill='currentColor' class='{name.toLowerCase()}-icon'>
    <!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
...
<svg width="1em" height="1em" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" fill='currentColor' class='{name.toLowerCase()}-icon'>
    <!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
...
<style lang='scss'>
    ...
    svg {
        ...
        // &:is(.github-icon) { color:#b3b9b8; font-size: 1.15em;}
        &:is(.github-icon) { font-size: 1.15em;}
        &:is(.fediverse-icon) { font-size: 1.1em; }
